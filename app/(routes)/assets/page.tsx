...
export default async function page({ searchParams }:
    { searchParams: Promise<{ status: Status, category: Category, page: string, query: string, type: AssetType, user: string }> }
){
await authProtection()
    ...
    const {status, category, type ,user} = params;
    ...
    return (
            ...
            <AssetList status={status || null} category={category || null} query={query || null} user={user || null} type={type || null} currentPage={page}/>
                </Suspense>
